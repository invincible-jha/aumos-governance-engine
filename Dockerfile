# ============================================================================
# Dockerfile — aumos-governance-engine
# Multi-stage build for production AI governance service
# ============================================================================
...
# Start service
CMD ["uvicorn", "aumos_governance_engine.main:app", "--host", "0.0.0.0", "--port", "8000", "--workers", "1"]
